...
{	
	...
	lr_end_transaction("PetStore_AddAproduct_T01",LR_AUTO);
	...
	lr_end_transaction("PetStore_SelectProductId_T02",LR_AUTO);
	...
	lr_end_transaction("PetStore_SelectItemId_T03",LR_AUTO);
	...
	lr_end_transaction("PetStore_AddToCard_T04",LR_AUTO);
